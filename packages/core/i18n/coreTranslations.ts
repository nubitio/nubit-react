...
export const coreTranslationsEs: CoreTranslationKeys = {
  ...
  'form.deleteError': 'No se pudo eliminar el registro',
  'form.loading': 'Cargando...',
  'form.groupOther': 'Otros',
  'grid.noRecords': 'No hay registros para mostrar',
  'grid.accessDeniedTitle': 'Acceso denegado',
  'grid.accessDeniedDescription': 'No tienes permiso para ver esta información.',
  'grid.loadErrorTitle': 'No se pudo cargar la información',
  'grid.loadErrorDescription': 'Ocurrió un error al consultar los datos. Intenta de nuevo.',
  ...
  'grid.buttonView': 'Ver',
  'grid.buttonExport': 'Exportar',
  'document.print': 'Imprimir',
  'document.reissue': 'Emitir corrección',
  'document.reissueConfirm':
    'Se emitirá una copia nueva que reemplaza a la anterior. La anterior seguirá siendo legible.',
  'document.download': 'Descargar',
  'document.history': 'Historial de emisiones',
  'document.pending': 'Generando el documento…',
  'document.failed': 'No se pudo generar el documento',
  'document.superseded': 'Reemplazado',
  'document.empty': 'Este registro aún no tiene documentos emitidos',
  'document.loading': 'Cargando…',
  'document.error': 'No se pudo cargar el historial',
  'import.title': 'Importar desde archivo',
  'import.chooseFile': 'Seleccionar archivo',
  'import.analyze': 'Analizar',
  'import.analyzing': 'Analizando el archivo…',
  'import.confirm': 'Aplicar importación',
  'import.applying': 'Aplicando…',
  'import.applied': 'Importación aplicada',
  'import.summary':
    '{{rows}} filas: {{inserts}} nuevas, {{updates}} actualizadas, {{invalid}} con errores',
  'import.nothingApplied': 'Nada se ha escrito todavía. Revisa el resumen antes de aplicar.',
  'import.blockedByErrors':
    'Corrige los errores del archivo y vuelve a subirlo: una importación parcial no es posible.',
  'import.errorsTitle': 'Filas con errores',
  'import.errorLine': 'Fila {{line}}',
  'import.unmapped': 'Campos sin columna: {{fields}}',
  'import.numberFormat': 'Formato numérico del archivo',
  'import.numberFormatAuto': 'Detectar',
  'import.numberFormatDot': '1,234.56',
  'import.numberFormatComma': '1.234,56',
  'import.failed': 'No se pudo procesar el archivo',
  'grid.exportError': 'No se pudo exportar. Intenta de nuevo.',
  ...
  'grid.inlineEditRow': 'Editar fila',
  'grid.inlineSaveRow': 'Guardar fila',
  'grid.inlineCancelRow': 'Cancelar edición',
  'grid.inlineSaveAll': 'Guardar todos ({{count}})',
  'grid.inlineDiscardAll': 'Descartar todos',
  'grid.inlineUnsavedRows': '{{count}} fila(s) con cambios sin guardar',
  'grid.inlineSaveChanges': 'Guardar cambios',
  'grid.inlineRevertChanges': 'Descartar cambios',
...
export const coreTranslationsEn: CoreTranslationKeys = {
  ...
  'form.deleteError': 'The record could not be deleted',
  'form.loading': 'Loading...',
  'form.groupOther': 'Other',
  'grid.noRecords': 'No records to display',
  'grid.accessDeniedTitle': 'Access denied',
  'grid.accessDeniedDescription': "You don't have permission to view this data.",
  'grid.loadErrorTitle': "Couldn't load data",
  'grid.loadErrorDescription': 'Something went wrong while fetching data. Please try again.',
  ...
  'grid.buttonExport': 'Export',
  'document.print': 'Print',
  'document.reissue': 'Issue correction',
  'document.reissueConfirm':
    'A new copy will be issued replacing the previous one. The previous copy stays readable.',
  'document.download': 'Download',
  'document.history': 'Issue history',
  'document.pending': 'Preparing the document…',
  'document.failed': 'The document could not be produced',
  'document.superseded': 'Superseded',
  'document.empty': 'No document has been issued for this record yet',
  'document.loading': 'Loading…',
  'document.error': 'The history could not be loaded',
  'import.title': 'Import from a file',
  'import.chooseFile': 'Choose a file',
  'import.analyze': 'Analyse',
  'import.analyzing': 'Analysing the file…',
  'import.confirm': 'Apply import',
  'import.applying': 'Applying…',
  'import.applied': 'Import applied',
  'import.summary': '{{rows}} rows: {{inserts}} new, {{updates}} updated, {{invalid}} with errors',
  'import.nothingApplied': 'Nothing has been written yet. Review the summary before applying.',
  'import.blockedByErrors':
    'Fix the errors in the file and upload it again; a partial import is not possible.',
  'import.errorsTitle': 'Rows with errors',
  'import.errorLine': 'Row {{line}}',
  'import.unmapped': 'Fields with no column: {{fields}}',
  'import.numberFormat': 'Number format in the file',
  'import.numberFormatAuto': 'Detect',
  'import.numberFormatDot': '1,234.56',
  'import.numberFormatComma': '1.234,56',
  'import.failed': 'The file could not be processed',
  'grid.exportError': "Couldn't export. Try again.",
  ...
  'grid.inlineEditRow': 'Edit row',
  'grid.inlineSaveRow': 'Save row',
  'grid.inlineCancelRow': 'Cancel edit',
  'grid.inlineSaveAll': 'Save all ({{count}})',
  'grid.inlineDiscardAll': 'Discard all',
  'grid.inlineUnsavedRows': '{{count}} row(s) with unsaved changes',
  'grid.inlineSaveChanges': 'Save changes',
  'grid.inlineRevertChanges': 'Revert changes',
