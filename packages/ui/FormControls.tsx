...
export const TextField = forwardRef<HTMLInputElement, TextFieldProps>(function TextField(
  ...
  return (
    <input
      {...props}
      ref={ref}
      className={cx('nb-input', invalid && 'nb-input--invalid', className)}
    />
  );
});
...
export const SelectField = forwardRef<HTMLSelectElement, SelectFieldProps>(function SelectField(
  ...
  return (
    <select
      {...props}
      ref={ref}
      className={cx('nb-input', 'nb-select', invalid && 'nb-input--invalid', className)}
    >
      {children}
    </select>
  );
...
export const TextAreaField = forwardRef<HTMLTextAreaElement, TextAreaFieldProps>(
  function TextAreaField({ className, invalid, ...props }, ref) {
    return (
      <textarea
        {...props}
        ref={ref}
        className={cx('nb-input', 'nb-textarea', invalid && 'nb-input--invalid', className)}
      />
    );
  },
);
